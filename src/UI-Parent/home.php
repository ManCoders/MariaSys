    ...
    <div class="modal-content">
      <form id="enrollmentForm" method="POST">
        <div class="modal-header bg-danger">
          ...
          <button type="button" class="btn-close btn-danger text-" data-bs-dismiss="modal" aria-label="Close"
            id="closeBtnModal"></button>
        </div>
        ...
        <div class="modal-footer">
          <button type="submit" class="btn btn-danger btn-xs">Submit Enrollment</button>
          <button type="button" class="btn btn-secondary btn-xs" id="closeBtnModal" data-bs-dismiss="modal"
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header bg-danger">
        ...
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" id="closeBtnModal"></button>
      </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-danger btn-xs" id="editEnrolleeBtn" data-bs-toggle="modal"
          data-bs-target="#editEnrolleeModal">Edit</button>
        <button type="button" class="btn btn-secondary btn-xs" id="closeBtnModal" data-bs-dismiss="modal"
          aria-label="Close">Close</button>
      </div>
    </div>
...
<div class="modal fade" id="editEnrolleeModal" tabindex="-1" aria-labelledby="editEnrolleeModalLabel"
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <form id="editEnrolleeForm" method="POST">
        <div class="modal-header bg-danger">
          <h5 class="modal-title text-white" id="editEnrolleeModalLabel">Edit Enrollee Information</h5>
          ...
          <div>
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="guardianName" name="guardianName" value="Maria Dela Cruz"
                  required>
              </div>
              <div class="col-md-6 mb-3">
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="tel" class="form-control" id="contactNumber" name="contactNumber" value="09171234567"
                  required>
              </div>
            </div>
        ...
        <div class="modal-footer">
          <button type="submit" class="btn btn-danger btn-xs">Save Changes</button>
          <button type="button" class="btn btn-secondary btn-xs" id="closeBtnModal" data-bs-dismiss="modal"
...
<script>
  $(document).ready(function () {
    $('body').on('click', '#closeBtnModal', function () {

      $('#viewEnrolleeModal').modal('hide');
      $('#editEnrolleeModal').modal('hide');
