<div class="container vh-100">
  ...
  <div class="text-center mb-2">
    ...
    <button type="button" class="btn-xm btn btn-xm btn-danger" id="register_child" data-bs-toggle="modal"
    ...
    <div class="col-md-6 col-lg-4">
      <div class="card h-100 shadow-sm">
        ...
        <div class="card-footer mx-auto mb-0">
          ...
          <button class="btn-xm btn btn-xm btn-xs btn-xm btn-danger" data-bs-toggle="modal"
            data-bs-target="#viewEnrolleeModal"><i class="fa fa-eye me-2"></i>View</button>
        </div>
      </div>
    </div>
      ...
      <div class="card h-100 shadow-sm">
        ...
        <div class="card-footer mx-auto mb-0">
          <button class=" btn  btn-xs btn-danger" data-bs-toggle="modal"
            data-bs-target="#viewEnrolleeModal"><i class="fa fa-eye me-2"></i>View</button>
          <button type="button" class=" btn btn-xs btn-danger" id="editEnrolleebtn-xm Btn"
            data-bs-toggle="modal" data-bs-target="#editEnrolleeModal"><i class="fa fa-edit me-2"></i>Edit</button>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="modal-content">
      <form>
        <div class="modal-header bg-danger  ">
          ...
          <button type="button" class=" btn-close btn-xm btn-danger " data-bs-dismiss="modal"
        ...
        <div class="modal-footer">
          <button type="submit" class=" btn btn-xs  btn-danger">Submit Enrollment</button>
...
<div class="modal fade" id="viewEnrolleeModal" tabindex="-1" aria-labelledby="viewEnrolleeModalLabel"
  aria-hidden="true">
  <div class="modal-dialog modal-xl modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header bg-danger">
        <h5 class="modal-title text-white" id="viewEnrolleeModalLabel">Enrollee Information</h5>
        <button type="button" class="btn-xm btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-xs btn-xm btn-secondary"
...
<div class="modal fade" id="editEnrolleeModal" tabindex="-1" aria-labelledby="editEnrolleeModalLabel"
  aria-hidden="true">
  <div class="modal-dialog modal-xl modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header bg-danger">
      ...
      <div class="modal-body">
        ...
        <div class="row align-items-start mb-4">
          ...
          <div class="col-md-9">
            <div class="row">
              ...
              <div class="col-md-4 mb-2">
                <label class="form-label fw-bold">Middle Name:</label>
                <input type="text" class="form-control" value="Santos" required>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            <label class="form-label fw-bold">Date of Birth:</label>
            <input type="date" class="form-control" value="2000-01-01" required>
          </div>
          <div class="col-md-6 mb-3">
            <label class="form-label fw-bold">Place of Birth:</label>
            <input type="text" class="form-control" value="Quezon City" required>
          </div>
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            <label class="form-label fw-bold">Parent/Guardian Name:</label>
            <input type="text" class="form-control" value="Maria Dela Cruz" required>
          </div>
          <div class="col-md-6 mb-3">
            <label class="form-label fw-bold">Relationship:</label>
            <input type="text" class="form-control" value="Mother" required>
          </div>

          <div class="col-md-6 mb-3">
            <label class="form-label fw-bold">Occupation:</label>
            <input type="text" class="form-control" value="Teacher" required>
          </div>
          <div class="col-md-6 mb-3">
            <label class="form-label fw-bold">Contact Number:</label>
            <input type="text" class="form-control" value="09171234567" required>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-12 mb-3">
            ...
            <textarea class="form-control" rows="3"
              required>123 Sampaguita St., Brgy. Malinis, Quezon City, Metro Manila</textarea>
      ...
      <div class="modal-footer">
        <button type="submit" class=" btn btn-xs btn-danger">Update</button>
        <button type="button" class=" btn btn-xs btn-secondary" data-bs-dismiss="modal">Close</button>
      </div>
    </div>
  </div>
