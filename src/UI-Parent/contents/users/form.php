<section class="p-2">
    <div class="">
        <div class="d-flex justify-content-between align-items-center mb-0 flex-column col-md-12 col-12">
            <div class="col-md-12 col-12 align-items-start justify-content-start">
            ...
            <div class="modal-body d-flex col-md-12 col-12 flex-wrap align-items-center justify-content-center gap-2">
                ...
                <div class="d-flex flex-column col-md-3 col-11 ms-2">
                    ...
                    <input type="text" name="BirthPLace" placeholder="Birth Place (city/Muntinlupa)"
                        class="form-control">
                </div>
                <div class="d-flex flex-column col-md-3 col-11 ms-2">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-check"><input class="form-check-input" type="checkbox"
                                    name="manifestations[]" value="ApplyingKnowledge"> Difficulty in Applying Knowledge
                            </div>
                            <div class="form-check"><input class="form-check-input" type="checkbox"
                                    name="manifestations[]" value="Communicating"> Difficulty in Communicating</div>
                            <div class="form-check"><input class="form-check-input" type="checkbox"
                                    name="manifestations[]" value="Interpersonal"> Difficulty in Interpersonal Behavior
                            </div>
                            <div class="form-check"><input class="form-check-input" type="checkbox"
                                    name="manifestations[]" value="Behavioral"> Difficulty in Behavior</div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-check"><input class="form-check-input" type="checkbox"
                                    name="manifestations[]" value="Mobility"> Difficulty in Mobility (Walking, Climbing)
                            </div>
                            <div class="form-check"><input class="form-check-input" type="checkbox"
                                    name="manifestations[]" value="AdaptiveSelfCare"> Difficulty in Performing Adaptive
                                Self-Care</div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-check"><input class="form-check-input" type="checkbox"
                                    name="manifestations[]" value="Remembering"> Difficulty in Remembering,
                                Concentrating, Playing Attention</div>
                            <div class="form-check"><input class="form-check-input" type="checkbox"
                                    name="manifestations[]" value="Seeing"> Difficulty in Seeing</div>
                            <div class="form-check"><input class="form-check-input" type="checkbox"
                                    name="manifestations[]" value="Hearing"> Difficulty in Hearing</div>
                        </div>
                    </div>
                </div>
