...
if (isset($_GET['studentId']) && isset($_GET['subject_id']) && isset($_GET['teacher_id'])) {
    deleteStudentSubjectById($_GET['studentId'], $_GET['subject_id'], $_GET['teacher_id']);
}
        ...
        <div class="dashboard-container">
            ...
            <table border="1" cellpadding="5" cellspacing="0">
                ...
                <tbody>
                    ...
                    $students = getSubjectList($teacher_id); // Get students
                    
                    if (!empty($students)) {
                        foreach ($students as $student) {
                            $student2 = getStudentById($students['student_id']);
                            foreach ($student2 as $student3) {
                                ...
                                echo "<tr>
                                        ...
                                        <td>{$section['section_name']}</td>
                                        <td>
                                            <a href='Update_subject.php?teacher_id={$student['teacher_id']}&subject_name={$student['name']}&student_id={$student['student_id']}&subject_id={$student['subject_id']}'>
