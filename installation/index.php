...
<section class="p-2">
    ...
    <!-- STUDENT VIEW MODAL - LANDSCAPE STYLE (Exact Match to student_view.php) -->
    <div class="modal fade" id="viewStudentModal" tabindex="-1" aria-labelledby="viewStudentModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-landscape">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- Student Profile Section - Exact Match to student_view.php -->
                    <div class="row mb-4">
                        <div class="col-md-4">
                            <div class="card" style="box-shadow: 0 2px 6px rgba(0, 0, 0, 0.1);">
...
<script>
    ...
    $(document).ready(function () {
        ...
        // Edit Student Form Submission (Frontend Only - Backend Developer to implement)
